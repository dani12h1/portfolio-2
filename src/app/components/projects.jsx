  ...
  return (
    <>
      ...
      <AnimationEffect delay={0.2}>
        <motion.section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 mt-6 gap-5 container mx-auto my-20 mb-10">
          {[
            ...
            <a key={index} href={project.href} className="mx-auto" onMouseEnter={() => handleHover(index)} onMouseLeave={handleMouseLeave}>
              ...
              <Image className=" bject-none mx-auto pt-4 hover:shadow-xl lg:min-h-64 md:min-h-64" src={project.image} alt="projects" />
            </a>
          ))}
        </motion.section>
      </AnimationEffect>
