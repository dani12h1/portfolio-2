...
function HeroSection() {
  return (
    <>
      <section className="bg-hvid text-black container mx-auto mb-24 flex flex-col lg:flex-row items-center justify-center mt-28 h-[75vh] gap-14">
        ...
        <div className=" lg:order-1 text-center lg:text-left">
          ...
          <motion.h2 initial={{ opacity: 0, y: -180 }} animate={{ opacity: 1, y: 0 }} transition={{ ease: "easeInOut", duration: 0.9, delay: 0.2 }} className="text-black font-thin lg:text-3xl text-2xl lg:text-left">
