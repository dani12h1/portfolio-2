        ...
        <section className="mt-24 lg:mt-36 container mx-auto">
          <div className="lg:flex gap-36 justify-center items-center ">
            ...
            <p className="lg:mt-0 mt-12 lg:mb-0 mb-12">
              Hi i&apos;m Daniel! <br></br> <br></br> a multimediadesigner dedicated to creating fun and innovative digital solutions. Through this portfolio, I invite you to explore my work and discover the different projects I&apos;ve had the privilege to be a part of. <br></br>
